      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 border border-border text-sm font-medium rounded-lg text-foreground hover:border-zinc-400 dark:hover:border-zinc-600 hover:bg-background transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/30 focus-visible:ring-offset-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
